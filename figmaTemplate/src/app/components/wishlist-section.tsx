...
const initialMembers: FamilyMember[] = [
  { id: "1", name: "Sarah", wishlist: "• Cozy throw blanket\n• Coffee table book on architecture\n• Artisanal candles" },
  { id: "2", name: "Michael", wishlist: "• Wireless headphones\n• Fitness tracker\n• Cookbook for grilling" },
  { id: "3", name: "Emma", wishlist: "• Art supplies set\n• Journal with fountain pen\n• Yoga mat" },
  { id: "4", name: "David", wishlist: "• Board games\n• Premium coffee beans\n• Outdoor camping gear" },
  { id: "5", name: "Olivia", wishlist: "• Skincare set\n• Reading lamp\n• Plant terrarium kit" },
  { id: "6", name: "James", wishlist: "• Tech gadget organizer\n• Book series\n• Running shoes" },
];
...
export function WishlistSection({ readOnly = false }: WishlistSectionProps) {
  ...
  const handleSave = (id: string, newWishlist: string) => {
    setMembers(members.map(m => 
      m.id === id ? { ...m, wishlist: newWishlist } : m
    ));
    setEditingId(null);
  };
                ...
                {editingId === member.id ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <Button
                        onClick={() => {
                          const textarea = document.getElementById(`wishlist-${member.id}`) as HTMLTextAreaElement;
